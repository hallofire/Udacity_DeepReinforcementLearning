...
This project uses Python 3 (used in JupyterNotebook and PyCharm). 
Some libraries are necessary to run the notebook:
1. Pandas
2. Numpy
3. MatplotLib
4. PyTorch
...
In the last package different packages are included. To install it uncommend the ```!pip -q  install ./python``` command in the code.